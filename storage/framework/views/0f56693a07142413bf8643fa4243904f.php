...
<div class="table-item" title="Detail" onclick="return !window.open('<?php echo e(route('admin_ports_show',['id' => $item->id])); ?>','','width=1000,height=800')"><i class="fa-solid fa-angles-right"></i></div>
...
<?php /**PATH X:\BFT\Project\Laravel\project_x\resources\views/admin/ports/table_item.blade.php ENDPATH**/ ?>