        ...
        <div class="table-form-box">
            <table id="users">
                ...
                @foreach($userData as $item)
                    <tr>
                        <td class="item_checkbox"><input type="checkbox" name="is_allowed-{{$item->id}}" value="on"
                        ...
                        <td class="item_status">@if( optional($item->user_login_permission)->is_allowed)
                            ...
                            @endif</td>
                        <td class="item_delete"><a class="btn btn-danger" href="{{route('admin_users_destroy',['id' => $item->id]) }}">
