...
<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Welcome to <span style="text-transform: capitalize;">{{$settingsData->company_name}}</span> System Monitoring Application!
    </h1>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Name: {{optional(\App\Models\User::first())->name}}<br>
            Email: {{optional(\App\Models\User::first())->email}}
        </p>

        <p class="mt-4 text-sm">
            <a href="mailto:{{optional(\App\Models\User::first())->email}}" class="inline-flex items-center font-semibold text-indigo-700">
                Send Mail
